defmodule SchedulerExternalWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SchedulerExternalWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SchedulerExternalWeb.Gettext, "errors", msg, opts)
    end
  end
