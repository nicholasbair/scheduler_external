defmodule SchedulerExternalWeb.ProfileLiveTest do
  use SchedulerExternalWeb.ConnCase

  import Phoenix.LiveViewTest
  import SchedulerExternal.ProfilesFixtures

  @create_attrs %{description: "some description", name: "some name", public: true}
  @update_attrs %{description: "some updated description", name: "some updated name", public: false}
  @invalid_attrs %{description: nil, name: nil, public: false}
